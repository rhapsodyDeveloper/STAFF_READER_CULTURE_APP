...
class Pushmodel extends CI_Model
{
    ...
    function send() {
		...
		$sQuery = "select $this->user_deviceTable.device_type, $this->user_deviceTable.device_code from $this->user_deviceTable ".$where." ORDER BY modified DESC";
		}/*This condition is for ANDROID ONLY*/
		else if($sendIOS<>"" &&  $sendANDROID == ""){
		...
		$sQuery = "select $this->user_deviceTable.device_type, $this->user_deviceTable.device_code from $this->user_deviceTable".$where." ORDER BY modified DESC";
		}/*This condition is for IOS ONLY*/
		else if($sendIOS<>"" &&  $sendANDROID <> ""){
